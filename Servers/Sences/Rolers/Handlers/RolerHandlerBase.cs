...
{
    public abstract class RolerHandlerBase : OnTmTransfer
    {
        private Timer TmTimer;
        private int ValTime = 1000;
        public RolerHandlerBase()
        {
            TumoRolerHandler.Instance.RolerHandlers.Add(Code, this);
            TmAwake();
            TumoTimer(ValTime);
            Console.WriteLine("RolerHandler:" + this.GetType().Name + " is register.");
        }
