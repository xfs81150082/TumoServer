...
{
    class BookerMysqlTabler : GameMysqlBase
    {
        ...
        public List<TmSkillItem> skillItems { get; private set; }
        //private string SoulName = "soul";
        private string SoulItemName = "bookeritem";

        public BookerMysqlTabler()
        {
            //GetItems();
        }
        ...
        //void GetItems()
        //{
        //    List<TmSoulerItem> lists = GetSoulItems();
        //    for (int i = 0; i < lists.Count; i++)
        //    {
        //        NodeInfo.Instance.Bookers.Add(lists[i].Id, lists[i]);
        //    }
        //    Console.WriteLine("BookerMysqlTabler-Bookers: " + NodeInfo.Instance.Bookers.Count);
        //}
