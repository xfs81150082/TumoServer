...
{
    class TerrainMysqlTabler : GameMysqlBase
    {
        ...
        public TerrainMysqlTabler()
        {
            //UpdateTerrainItems(); //Test
        }
        ...
        void UpdateTerrainItems()
        {
            ...
            //if (items != null)
            //{
            //    NodeInfo.Instance.TerrainItems = items;
            //}
            //else
            //{
            //    Console.WriteLine("TerrainMysqlTabler-InventoryItems（地面无物品）： " + NodeInfo.Instance.TerrainItems.Count);
            //}
            //Console.WriteLine("TerrainMysqlTabler-InventoryItems: " + items.Count + " One: " + NodeInfo.Instance.TerrainItems.Count);
        }
