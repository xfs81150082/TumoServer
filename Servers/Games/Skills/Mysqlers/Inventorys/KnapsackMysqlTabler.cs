...
{
    class KnapsackMysqlTabler : GameMysqlBase
    {
        ...
        private string ItemTableName = "knapsackitem";

        public KnapsackMysqlTabler()
        {
        ...
        void UpdateKnapsackByRolerId(int rolerid)
        {
            ...
            ////NodeInfo.Instance.KnapsackItems.TryGetValue(rolerid, out tems);
            ////if (tems != null)
            ////{
            ////    tems = items;
            ////}
            ////else
            ////{
            ////    NodeInfo.Instance.KnapsackItems.Add(rolerid, items);
            ////}
            ////Console.WriteLine("KnapsackMysqlTabler-InventoryItems: " + items.Count + " One: " + NodeInfo.Instance.KnapsackItems.Count);
        }
