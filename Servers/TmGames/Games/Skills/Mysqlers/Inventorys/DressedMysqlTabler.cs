...
{
    class DressedMysqlTabler : GameMysqlBase
    {
        ...
        private string ItemTableName = "dresseditem";

        public DressedMysqlTabler()
        {
            //UpdateKnapsackByRolerId(151011); //Test
        }

        void UpdateKnapsackByRolerId(int rolerid)
        {
            //Dictionary<int,InventoryItem> items = GetInventoryItemsByRolerId(rolerid);
            //Dictionary<int, InventoryItem> tems;
            //NodeInfo.Instance.DressedItems.TryGetValue(rolerid, out tems);
            //if (tems != null)
            //{
            //    tems = items;
            //}
            //else
            //{
            //    NodeInfo.Instance.DressedItems.Add(rolerid, items);
            //}
            //Console.WriteLine("DressedMysqlTabler-InventoryItems: " + items.Count + " NodeInfo: " + NodeInfo.Instance.DressedItems.Count);
        }

        //Dictionary<int, InventoryItem> GetInventoryItemsByRolerId(int rolerid)
        //{
        ...
        //        item.Inventory = inv;
        //        items.Add((int)item.Inventory.EquipType, item);
        //    }
        //    return items;
