...
namespace Tumo
{
    public abstract class TmCoolDownItem : TmSystem
    {
        public int Id { get => id; set => id = value; }
        public string Key { get => key; set => key = value; }
        public TmCoolDown CoolDown { get => coolDown; set => coolDown = value; }
        ...
        private int id = 1;
        private string key;
        private TmCoolDown coolDown = new TmCoolDown(14, 4);
        private int cdCount = 0;
        private int cdTime = 0;
        private bool start = false;
        private bool end = false;
        public TmCoolDownItem() { }
